...
{//TODO:add versioning and rate limit
    ...
    [Authorize]
    public class SubsidiarysController : ControllerBase
    {//TODO:add get by id and lvl for master and subs
        private readonly ISubsidiaryService _personService;

        public SubsidiarysController(ISubsidiaryService personService)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateSubsidiaryDto dto)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, [FromBody] UpdateSubsidiaryDto dto)
        {
        ...
        public async Task<IActionResult> ExportSubsidiarysToExcel([FromQuery] QueryParameters parameters)
        {//by chat gbt 
            ...
            var fileName = $"Subsidiarys_{DateTime.Now:yyyyMMddHHmmss}.xlsx";
